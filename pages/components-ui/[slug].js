...
import { Box, Link, Grid, Stack, Divider, Container, Typography } from '@mui/material'
// utils
...
export default function ComponentUIPage({ component }) {
...
ComponentUIPage.getLayout = function getLayout(page) {
