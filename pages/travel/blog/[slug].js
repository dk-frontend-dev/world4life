...
// utils
import { getAllPosts, getPostData, getAllPostSlugs } from '../../../src/utils/get-mardown/travel/posts'
// _data
import _mock from '../../../_data/mock'
// layouts
import Layout from '../../../src/layouts'
// components
import { Breadcrumbs, Page, Markdown } from '../../../src/components'
// sections
import { BlogSidebar, BlogAuthorInfo, BlogTravelPostHero, BlogTravelLatestPosts } from '../../../src/sections/blog'
    ...
    <Page title={`${title} - Post | Travel`}>
      <RootStyle>
        ...
        <Container>
          <Breadcrumbs
            sx={{ my: 3 }}
            links={[{ name: 'Home', href: '/' }, { name: 'Blog', href: Routes.travel.posts }, { name: title }]}
          />
        </Container>
