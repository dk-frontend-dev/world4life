...
import { Grid, Stack, Button, Divider, Container, Typography, FilledInput, InputAdornment } from '@mui/material'
// utils
...
const BarStyle = styled((props) => (
  <Stack spacing={2.5} alignItems={{ md: 'center' }} direction={{ xs: 'column', md: 'row' }} {...props} />
))(({ theme }) => ({
  width: '100%',
  [theme.breakpoints.up('md')]: {
    ...cssStyles().bgBlur({
