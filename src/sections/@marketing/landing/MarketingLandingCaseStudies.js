      ...
      <Grid container>
        ...
        <Grid item xs={12} md={6}>
          <Stack alignItems='flex-end' justifyContent='space-between' sx={{ p: 3, pt: 5, height: 1 }}>
            ...
            <NextLink as={Routes.marketing.caseStudy(slug)} href={Routes.marketing.caseStudy('[slug]')} passHref>
              <Button
                size='small'
                color='inherit'
    ...
    <NextLink as={Routes.marketing.caseStudy(slug)} href={Routes.marketing.caseStudy('[slug]')} passHref>
      ...
      >
        ...
        <m.div variants={varHover(1.25)} transition={varTranHover()}>
          <Image alt='cover' src={coverImg} ratio={(isSquare && '1/1') || (isDesktop && '3/4') || '1/1'} />
        </m.div>
      </Paper>
    </NextLink>
  )
