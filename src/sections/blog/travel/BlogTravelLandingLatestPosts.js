...
// components
import { Image, Iconify, TextMaxLine, CarouselDots, CarouselArrows } from '../../../components'
...
export default function BlogMarketingLatestPosts({ posts }) {
  ...
  return (
    <RootStyle>
      <Typography variant='h2' sx={{ py: 8, px: 2.5, color: 'common.white', display: { md: 'none' } }}>
        Latest Posts
      </Typography>
...
function PostCarouselItem({ post, imageSize }) {
  const { slug, frontmatter } = post
