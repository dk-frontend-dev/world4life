          ...
          <Grid item xs={12} md={6} lg={5}>
            ...
            >
              ...
              <BarStyle spacing={{ xs: 1, md: 0 }}>
                <CareerJobKeywordFilter filterKeyword={filters.filterKeyword} onChangeKeyword={handleChangeKeyword} />
                <Divider
...
function BrandsSection() {
  return (
    <Stack flexWrap='wrap' direction={{ md: 'row' }} alignItems={{ md: 'center' }} sx={{ pt: { md: 1 } }}>
...
function SummarySection() {
  return (
    <Stack spacing={3} direction={{ xs: 'column', md: 'row' }} divider={DividerStyle} sx={{ pt: { md: 5 } }}>
