...
// components
import { Image, Iconify, TextMaxLine, CarouselDots, TextIconLabel } from '../../../components'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TextIconLabel icon={<Iconify icon={timeIcon} />} value={duration} sx={{ typography: 'subtitle2' }} />
  ...
  return (
    ...
    >
      ...
      <Stack spacing={0.5}>
        ...
        <TextIconLabel
          icon={<Iconify icon={locationIcon} sx={{ width: 20, height: 20, mr: 1, color: 'primary.main' }} />}
          value={
