    ...
    <Container>
        ...
        {SUMMARY.map((value) => (
          <div key={value.name}>
            <Typography variant='h2' gutterBottom>
              <Typography variant='h4' component='span' sx={{ verticalAlign: 'top', ml: 0.5, color: 'primary.main' }}>
                +
              </Typography>
            </Typography>
      ...
      >
        ...
        <Grid item xs={12} md={6} lg={6}>
          ...
          <Typography sx={{ color: 'text.secondary' }}>
            Fusce convallis metus id felis luctus adipiscing. Etiam imperdiet imperdiet orci. Vestibulum eu odio.
            Phasellus nec sem in justo pellentesque facilisis.
            <br />
            <br />
            Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. Maecenas nec odio et ante tincidunt
            tempus. Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi. Vestibulum eu odio. Curabitur
