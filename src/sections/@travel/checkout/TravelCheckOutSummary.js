  ...
  return (
    <Card>
      ...
      <Stack sx={{ p: 4, pb: 3 }}>
        ...
        >
          <Stack direction='row' spacing={1.5} sx={{ width: 1 }}>
            ...
            <Stack spacing={0.5}>
              ...
              <TravelTourFilterGuests guests={guests} setGuests={setGuests} sx={{ ...resetInputStyles }} />
            </Stack>
          </Stack>
        ...
        <Stack spacing={1} direction='row' alignItems='center' justifyContent='space-between' sx={{ mt: 3, mb: 2 }}>
