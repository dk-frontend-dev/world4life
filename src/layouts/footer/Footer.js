...
function ListMobile({ list }) {
  ...
  return (
    <Stack spacing={1.5} alignItems='flex-start'>
      <Typography variant='h6' onClick={onExpand} sx={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
        {subheader}
        <Iconify icon={expand ? chevronDown : chevronRight} sx={{ width: 20, height: 20, ml: 0.5 }} />
      </Typography>
